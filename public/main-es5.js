...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsCertCertComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsEncryptEncryptComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsListListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<h2 class=\"page-header\">User List </h2>\n<p>\n  Show user list registered in this server...\n</p>\n<table class=\"table table-striped\">\n  <thead class=\"thead-dark\">\n    <tr>\n      <th>Name</th>\n      <th>Username</th>\n      <th>Email</th>\n      <th>Age</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor=\"let user of users\">\n      <td>{{user.name}}</td>\n      <td>{{user.username}}</td>\n      <td>{{user.email}}</td>\n      <td>{{user.age}}</td>\n    </tr>\n  </tbody>\n</table>\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsMacMacComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_encrypt_encrypt_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/encrypt/encrypt.component */
    "./src/app/components/encrypt/encrypt.component.ts");
    /* harmony import */


    var _components_mac_mac_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/mac/mac.component */
    ...
    var _components_cert_cert_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/cert/cert.component */
    ...
    var routes = [{
      ...
      path: 'list',
      component: _components_list_list_component__WEBPACK_IMPORTED_MODULE_9__["ListComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]]
    }, {
      path: 'encrypt',
      component: _components_encrypt_encrypt_component__WEBPACK_IMPORTED_MODULE_11__["EncryptComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]]
    }, {
      path: 'mac',
      component: _components_mac_mac_component__WEBPACK_IMPORTED_MODULE_12__["MacComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]]
    }, {
      path: 'blog',
      component: _components_blog_blog_component__WEBPACK_IMPORTED_MODULE_13__["BlogComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]]
    }, {
      path: 'cert',
      component: _components_cert_cert_component__WEBPACK_IMPORTED_MODULE_15__["CertComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_list_list_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/list/list.component */
    "./src/app/components/list/list.component.ts");
    /* harmony import */
    ...
    var _components_encrypt_encrypt_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./components/encrypt/encrypt.component */
    "./src/app/components/encrypt/encrypt.component.ts");
    /* harmony import */


    var _components_mac_mac_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./components/mac/mac.component */
    "./src/app/components/mac/mac.component.ts");
    /* harmony import */


    var _components_blog_blog_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./components/blog/blog.component */
    "./src/app/components/blog/blog.component.ts");
    /* harmony import */
    ...
    var _components_cert_cert_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./components/cert/cert.component */
    "./src/app/components/cert/cert.component.ts");
    ...
    function () {
      ...
      _createClass(BlogComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getBlog().subscribe(function (blog) {
            _this.name = blog.user.name;
            _this.username = blog.user.username;
            _this.email = blog.user.email;
            _this.age = blog.user.age;
          }, function (err) {
            console.log(err);
            return false;
          });
  ...
  /***/
  function srcAppComponentsCertCertComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCertCertComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CertComponent", function () {
    ...
    function () {
      function CertComponent(authService, router, flashMessage) {
        _classCallCheck(this, CertComponent);
      ...
      _createClass(CertComponent, [{
        ...
        value: function onCertRequest() {
          ...
          this.authService.certRequest(request).subscribe(function (data) {
            if (data.success) {
              _this2.authService.storeCert(data.cert, data.caCert);

              _this2.flashMessage.show('Your certificate was issued.', {
              ...
              _this2.flashMessage.show('Certificate issuing fails', {
                cssClass: 'alert-danger',
                timeout: 3000
              });

              _this2.router.navigate(['cert']);
            }
          });
        }
      }]);
    ...
    CertComponent.ctorParameters = function () {
      return [{
        type: src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]
    ...
    CertComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-cert',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./cert.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/cert/cert.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./cert.component.scss */
      "./src/app/components/cert/cert.component.scss")).default]
    })], CertComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsEncryptEncryptComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsEncryptEncryptComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EncryptComponent", function () {
    ...
    var node_forge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! node-forge */
    "./node_modules/node-forge/lib/index.js");
    /* harmony import */


    var node_forge__WEBPACK_IMPORTED_MODULE_4___default =
    /*#__PURE__*/
    __webpack_require__.n(node_forge__WEBPACK_IMPORTED_MODULE_4__);

    var EncryptComponent =
    /*#__PURE__*/
    function () {
      function EncryptComponent(authService, flashMessage) {
        _classCallCheck(this, EncryptComponent);

        this.authService = authService;
        this.flashMessage = flashMessage;
      }

      _createClass(EncryptComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "onEncryptSubmit",
        value: function onEncryptSubmit() {
          var _this3 = this;
          ...
          this.authService.encryptedMessage(this.encrypted, this.ctime, this.ptoken).subscribe(function (data) {
            if (data.decrypted) {
              _this3.decrypted = node_forge__WEBPACK_IMPORTED_MODULE_4__["util"].decodeUtf8(data.decrypted.data);
            }
          });
        }
      }]);
    ...
    EncryptComponent.ctorParameters = function () {
      return [{
        type: src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
      }, {
    ...
    EncryptComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-encrypt',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./encrypt.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/encrypt/encrypt.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./encrypt.component.scss */
      "./src/app/components/encrypt/encrypt.component.scss")).default]
    })], EncryptComponent);
    /***/
  },
  ...
  function srcAppComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var node_forge__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! node-forge */
    "./node_modules/node-forge/lib/index.js");
    /* harmony import */


    var node_forge__WEBPACK_IMPORTED_MODULE_5___default =
    /*#__PURE__*/
    __webpack_require__.n(node_forge__WEBPACK_IMPORTED_MODULE_5__);
    ...
    function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.connectHome().subscribe(function (data) {
            _this4.currentTime = new Date(data.currentTime); // Server current time

            _this4.nonceHex = data.nonceHex;
            _this4.caCertPem = data.caCertPem;
            _this4.signatureHex = data.signatureHex;
            var caCert = pki.certificateFromPem(data.caCertPem);
            var caPublicKey = caCert.publicKey;
            var signature = node_forge__WEBPACK_IMPORTED_MODULE_5__["util"].hexToBytes(data.signatureHex);
            var clientTime = new Date().getTime(); // Client current time

            var diff = clientTime - data.currentTime;
            var md = node_forge__WEBPACK_IMPORTED_MODULE_5__["md"].sha1.create();
            md.update(data.currentTime, 'utf8');
            md.update(data.nonceHex, 'utf8');
            var result = caPublicKey.verify(md.digest().bytes(), signature);

            if (result == true && diff < 100000) {
              _this4.verified = result;
              localStorage.setItem('caCert', data.caCertPem);
            }

            _this4.caCommon = caCert.subject.getField('CN').value;
            _this4.caOrganization = caCert.subject.getField('O').value;
            _this4.caOU = caCert.subject.getField('OU').value;
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(ListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getList().subscribe(function (users) {
            _this5.users = users;
          });
        }
      }]);
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // ID/Pass login
        ...
        value: function onLoginSubmit() {
          ...
          // Get ca certificate
          var caCertPem = localStorage.getItem('caCert');
          var caCert = pki.certificateFromPem(caCertPem);
          var caPublicKey = caCert.publicKey; // Build up LoginInfo

          var loginInfo = {
            username: this.username,
            password: this.password
          };
          var loginInfoJson = JSON.stringify(loginInfo); // Encrypt LoginInfo with CA's public key

          var key = node_forge__WEBPACK_IMPORTED_MODULE_5__["random"].getBytesSync(16); // Random Session Key for AES encryption

          var cipher = node_forge__WEBPACK_IMPORTED_MODULE_5__["cipher"].createCipher('AES-ECB', key);
          cipher.start();
          cipher.update(node_forge__WEBPACK_IMPORTED_MODULE_5__["util"].createBuffer(loginInfoJson, 'binary'));
          cipher.finish();
          var ciphertext = cipher.output; // Encrypted userInfo

          var ciphertextHex = node_forge__WEBPACK_IMPORTED_MODULE_5__["util"].bytesToHex(ciphertext);
          var encryptedKey = caPublicKey.encrypt(key, 'RSA-OAEP'); // Encrypted session key with server's public key

          var encryptedKeyHex = node_forge__WEBPACK_IMPORTED_MODULE_5__["util"].bytesToHex(encryptedKey); // Encrypted LoginInfo.
          ...
          this.authService.authenticateUser(loginInfoEnc).subscribe(function (data) {
            if (data.success) {
              // Recover UserInfo
              var ciphertextToHex = data.ciphertextToHex;

              var _ciphertext = node_forge__WEBPACK_IMPORTED_MODULE_5__["util"].hexToBytes(ciphertextToHex);

              var decipher = node_forge__WEBPACK_IMPORTED_MODULE_5__["cipher"].createDecipher('AES-ECB', key);
              decipher.start();
              decipher.update(node_forge__WEBPACK_IMPORTED_MODULE_5__["util"].createBuffer(_ciphertext, 'binary'));
              decipher.finish();
              var recovered = decipher.output;
              var recoveredParse = JSON.parse(recovered);
              var ptoken = recoveredParse.ptoken;
              var stoken = recoveredParse.stoken;
              var userNoPW = recoveredParse.userNoPW;
              _this6.userNoPW = userNoPW; // Store Token and User Info

              _this6.authService.storeUserData(ptoken, stoken, userNoPW);

              _this6.flashMessage.show('You are now logged in', {
                cssClass: 'alert-success',
                timeout: 5000
              });

              _this6.router.navigate(['dashboard']); //Logged in and Redirect to dashboard
              ...
              _this6.router.navigate(['login']); // Login failed and redirect to Login page
        ...
        key: "onLoginSigSubmit",
        value: function onLoginSigSubmit() {
          var _this7 = this;

          this.authService.authenticateSigUser().subscribe(function (data) {
            if (data.success) {
              _this7.authService.storeUserData(data.ptoken, data.stoken, data.userNoPW);

              _this7.flashMessage.show('Easy login successful', {
                cssClass: 'alert-success',
                timeout: 5000
              });
  ...
  /***/
  function srcAppComponentsMacMacComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsMacMacComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function MacComponent(authService, flashMessage) {
      ...
      _createClass(MacComponent, [{
        ...
        value: function onMacSubmit() {
          ...
          this.stoken = localStorage.getItem('stoken');
          this.key = this.authService.getKey(this.ctime, this.stoken);
          var plaintextUtf8 = node_forge__WEBPACK_IMPORTED_MODULE_4__["util"].encodeUtf8(this.plaintext);
          this.mac = this.authService.getMac(plaintextUtf8, this.key);
          this.authService.macMessage(plaintextUtf8, this.ctime, this.ptoken, this.mac).subscribe(function (data) {
            console.log(data);
            _this8.msg = data.msg;
          });
        }
    ...
    MacComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-mac',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./mac.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/mac/mac.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./mac.component.scss */
      "./src/app/components/mac/mac.component.scss")).default]
    })], MacComponent);
    /***/
  },
  ...
  function srcAppComponentsNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(NavbarComponent, [{
        ...
        key: "onDeleteCertClick",
        value: function onDeleteCertClick() {
    ...
    function () {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getProfile(this.ptoken, this.ctime, this.auth).subscribe(function (profile) {
            _this9.name = profile.userNoPW.name;
            _this9.username = profile.userNoPW.username;
            _this9.email = profile.userNoPW.email;
            _this9.age = profile.userNoPW.age;
          }, function (err) {
            console.log(err);
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var node_forge__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! node-forge */
    "./node_modules/node-forge/lib/index.js");
    /* harmony import */


    var node_forge__WEBPACK_IMPORTED_MODULE_6___default =
    /*#__PURE__*/
    __webpack_require__.n(node_forge__WEBPACK_IMPORTED_MODULE_6__);

    var pki = node_forge__WEBPACK_IMPORTED_MODULE_6__["pki"];
    ...
    function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onRegisterSubmit() {
          ...
          var caCertPem = localStorage.getItem('caCert');
          var caCert = pki.certificateFromPem(caCertPem);
          var caPublicKey = caCert.publicKey; // Check two password inputs

          if (this.password1 !== this.password2) {
            this.flashMessage.show('Two password inputs are not equal', {
              cssClass: 'alert-danger',
              timeout: 3000
            });
            return false;
          ...
          var userInfoJson = JSON.stringify(userInfo); // Check all input fields

          if (!this.validateService.validateRegister(userInfo)) {
            this.flashMessage.show('Fill out all required fields!', {
              cssClass: 'alert-danger',
              timeout: 3000
            });
            return false;
          ...
          if (!this.validateService.validateEmail(userInfo.email)) {
            this.flashMessage.show('Use correct email address!', {
              cssClass: 'alert-danger',
              timeout: 3000
            });
            return false;
          ...
          var key = node_forge__WEBPACK_IMPORTED_MODULE_6__["random"].getBytesSync(16); // Random Session Key for AES encryption

          var cipher = node_forge__WEBPACK_IMPORTED_MODULE_6__["cipher"].createCipher('AES-ECB', key);
          cipher.start();
          cipher.update(node_forge__WEBPACK_IMPORTED_MODULE_6__["util"].createBuffer(userInfoJson, 'binary'));
          cipher.finish();
          var ciphertext = cipher.output; // Encrypted userInfo

          var ciphertextHex = node_forge__WEBPACK_IMPORTED_MODULE_6__["util"].bytesToHex(ciphertext);
          var encryptedKey = caPublicKey.encrypt(key, 'RSA-OAEP'); // PublicKey-encrypted session key

          var encryptedKeyHex = node_forge__WEBPACK_IMPORTED_MODULE_6__["util"].bytesToHex(encryptedKey); // Encrypted Login Info
          ...
          this.authService.registerUser(register).subscribe(function (data) {
            if (data.success) {
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var pki = node_forge__WEBPACK_IMPORTED_MODULE_4__["pki"]; // Basic header option
    ...
    function () {
      ...
      _createClass(AuthService, [{
        ...
        key: "connectHome",
        value: function connectHome() {
          var homeUrl = this.prepEndpoint('users/home');
        ...
        key: "authenticateSigUser",
        value: function authenticateSigUser() {
          ...
          var username = cert.subject.getField('CN').value; // Signature generation on username, currentTime

          var md = node_forge__WEBPACK_IMPORTED_MODULE_4__["md"].sha1.create();
          md.update(username, 'utf8');
          md.update(currentTime, 'utf8');
          var signature = privateKey.sign(md);
          var signatureHex = node_forge__WEBPACK_IMPORTED_MODULE_4__["util"].bytesToHex(signature); // Easy login request
        ...
        key: "getProfile",
        value: function getProfile(ptoken, ctime, auth) {
        ...
        value: function getBlog() {
          ...
          var blogUrl = this.prepEndpoint('users/blog');
        ...
        value: function encryptedMessage(encrypted, ctime, ptoken) {
          ...
          var encryptUrl = this.prepEndpoint('users/encrypt');
          return this.http.get(encryptUrl, httpOptions3);
        }
      }, {
        key: "getEncrypt",
        value: function getEncrypt(plaintext, key) {
          var plaintextUtf8 = node_forge__WEBPACK_IMPORTED_MODULE_4__["util"].encodeUtf8(plaintext);
          var key1 = node_forge__WEBPACK_IMPORTED_MODULE_4__["util"].hexToBytes(key);
          var cipher = node_forge__WEBPACK_IMPORTED_MODULE_4__["cipher"].createCipher('AES-ECB', key1);
          cipher.start();
        ...
        key: "macMessage",
        value: function macMessage(plaintext, ctime, ptoken, mac) {
          ...
          var macUrl = this.prepEndpoint('users/mac');
          return this.http.get(macUrl, httpOptions4);
        }
      }, {
        key: "getMac",
        value: function getMac(plaintext, key) {
          var md = node_forge__WEBPACK_IMPORTED_MODULE_4__["md"].sha256.create();
        ...
        key: "certRequest",
        value: function certRequest(request) {
          // Key generation
          var keyPair = pki.rsa.generateKeyPair(2048);
          var publicKey = keyPair.publicKey;
          var privateKey = keyPair.privateKey;
          var publicKeyPem = pki.publicKeyToPem(publicKey);
          var privateKeyPem = pki.privateKeyToPem(privateKey); // Storing private key
        ...
        key: "storeUserData",
        value: function storeUserData(ptoken, stoken, userNoPW) {
        ...
        key: "getKey",
        value: function getKey(ctime, stoken) {
          var md = node_forge__WEBPACK_IMPORTED_MODULE_4__["md"].sha256.create();
        ...
        key: "computeAuth",
        value: function computeAuth(ctime, stoken) {
          var md = node_forge__WEBPACK_IMPORTED_MODULE_4__["md"].sha256.create();
          md.update(ctime + stoken);
          return md.digest().toHex();
        } // 6. Store certificate
        ...
        key: "storeCert",
        value: function storeCert(cert, caCert) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\RTA-Heroku\dta\angular-src\src\main.ts */
    "./src/main.ts");
    /***/
  },
